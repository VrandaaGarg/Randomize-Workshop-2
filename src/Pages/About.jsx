...
function About() {
  const workshopFlow = [
    ...
    },
    {
      ...
      points: ["Recap key concepts", "Share resources for further learning"],
    },
  ];

  return (
    <div className="min-h-screen bg-gradient-to-b from-slate-900 to-slate-700 py-24 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <div className="bg-white rounded-lg shadow-md p-8 mb-8">
          <p className="text-lg text-gray-700 mb-6">
            This comprehensive workshop is designed to help students master
            React development through practical, hands-on experience with modern
